...
const addAllWall = (
  ...
  mouseRaycasterIntersectObjectsRef.value?.push(instancedMesh);
  pointerControlsIntersetObjectsRef.value?.push(instancedMesh);
...
const addGlassWindow = (
  ...
  mouseRaycasterIntersectObjectsRef.value?.push(glassWindow);
  pointerControlsIntersetObjectsRef.value?.push(glassWindow);
...
const addPassEdgeBinding = (
  ...
  passEdgeBindingList.forEach((item: number[]) => {
    ...
    mouseRaycasterIntersectObjectsRef.value?.push(passEdgeBinding);
    pointerControlsIntersetObjectsRef.value?.push(passEdgeBinding);
