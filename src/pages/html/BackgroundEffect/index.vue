...
.container {
  ...
  .bg24 {
    @include bg;
    background: radial-gradient(ellipse 150% 150% at 80% 80%,
        transparent 40%,
  ...
  .bg25 {
    ...
    #170409 54% 57%,
    #0000 59%;
    background: radial-gradient(farthest-side at -33.33% 50%, $g) 0 calc($size/2),
  ...
  .bg26 {
    ...
    $color1: #c02942;
    $color2: #53777a;
    background: conic-gradient(at $size calc(100% - $size),
        #0000 270deg,
